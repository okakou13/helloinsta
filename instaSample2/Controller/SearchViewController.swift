...
//    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let userImageUrl = "https://mb.api.cloud.nifty.com/2013-09-01/applications/YuYPRyKcrM8yolIK/publicFiles/" + users[indexPath.row].objectId
...
//    }
    ...
    func didTapFollowButton(tableViewcell tableViewCell: UITableViewCell, button: UIButton) {
